...
<body style="background-color:#708090;">
    ...
    function TimeDriff() {
        ...
        if(st == null || st == '' || st == '0'){
            alert('กรุณาระบุวันที่เช็คอินให้ถูกต้อง');
            return false;
        }
    ...
    function TimeDriff2() {
        ...
        var start = new Array(3);
        var end = new Array(3);
        var st = document.getElementById('my_date_picker3').value;
    ...
    <script>
        function cc(){
            ...
            alert('กรุณาระบุวันที่เช็คอินให้ถูกต้อง');
            return false;
            window.location = 'reservation.php?id=<?php echo $id;?>';
            }

        }
    </script>
    <div class="form-style-10 w-75">
        <h1>ข้อมูลการจองห้อง<span></span></h1>
        <form action="booking_notification.php" method="get" onsubmit="cc(this)">
            <div class="section"><span>1</span>ห้องที่จอง</div>
            <div class="inner-wrap">
                <label>ประเภทการจอง * <input type="text" name="category" value="<?php echo $cname ?>"
                        readonly /></label>
                <label style="display:none">รหัสประเภทห้อง * <input type="text" name="rid" value="<?php echo $rrid ?>"
                        readonly /></label>
                <label>ประเภทห้อง *<input type="text" name="rtype" value="<?php echo $type_name?>" readonly /></label>
                <label>เตียง *<input type="text" name="bname" value="<?php echo $bname ?>" readonly /></label>
                <?php
                ...
                <label>เช็คอิน<input type="text" id="my_date_picker1" name="Check-In" onChange="TimeDriff()"
                readonly required /></label>
                
                <label>เช็คเอาท์<input type="text" id="my_date_picker2" name="Check-Out" onChange="TimeDriff()"
                readonly required /></label>
                ...
                <?php endif ?>
                <?php
                    if ($row['reservation'] == 2) :
                    ?>

                <label>เช็คอิน<input type="text" id="my_date_picker3" name="Check-In" readonly required /></label>
            ...
            <div class="inner-wrap">
                <label>ชื่อต้น </label>
                <select name="prefix_name" required>
                ...
                <label>ชื่อ <input type="text" name="fname" required /></label>
                <label>นามสกุล <input type="text" name="lname" required /></label>
                <label>เบอร์โทร <input type="text" name="phone" maxlength="10" minlength="10"
                        onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}" required /></label>
            </div>
...
<?php
     ...
     while($date_clost_list = mysqli_fetch_array($sate)){
            ...
            $m_ex = $m_ex -1;
            $date_clost_list_1 = $y_ex."-".$m_ex."-".$d_ex;
 
            echo "<input type='hidden' id='clost_date$i' value='".$date_clost_list_1."' >";
            array_push($z, "$i");
            $i++;

     }
     echo "<input type='hidden' id='limit_z' value='".sizeof($z)."'>";
?>
<script>
...
$(function() {
    ...
    var limit_z = document.getElementById('limit_z').value;
    var i = 0;
    function availablee(date) {
        // console.log(d.getDate());

        var date_check = date.getFullYear()+"-"+date.getMonth()+"-"+date.getDate();
        // console.log(date_clost_check);
        // var c = ['2022-10-24','2022-10-25'];
            
            
            // console.log(date_clost_check +"="+ date_check);   
            // while(i < limit_z){
                var date_clost_check = document.getElementById('clost_date'+i).value;
                // console.log(date_clost_check);
            ...
            // if(date_clost_check == date_check){
            //     console.log(date_clost_check +"="+ date_check);       
            // }else{
            //     console.log(i);
            //     i++;
