...
<body>
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a class="active-menu" href="usernt.php" ><i class="fa fa-user-times"></i> ผู้ใช้ที่ ไม่มีห้องพัก   <?php echo "<lable style='color:#FFFF99' ><i class='fa fa-user'></i>  ".$x."</lable>" ?></a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <a href="usernt.php"><button class='bnnc'><i class="fa fa-map-marker"></i>ลูกค้าที่ไม่มีห้องพัก</button></a>
    ...
    if (isset($_POST['adddata'])) {
        ...
        if ($psw1 != $psw2) {
            ...
            echo "<script type='text/javascript'> window.location='usernt.php'</script>";
        } else echo "Error psw";
