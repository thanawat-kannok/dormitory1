    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <ul class="nav" id="main-menu">
                        ...
                        <li>
                            <a class="active-menu" href="user.php" ><i class="fa fa-user-plus"></i> ผู้ใช้ที่ มีห้องพัก   <?php echo "<lable style='color:#FFFF99' ><i class='fa fa-user'></i>  ".$y."</lable>" ?></a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <br>
                <!-- <a href=""><button class='bnnc'><i class="fa fa-map-marker"></i> ลูกค้าที่มีห้องพัก</button></a>
                <a href="usernt.php"><button class='bnnt'>ลูกค้าที่ไม่มีห้องพัก</button></a>
                <a href="userall.php"><button class='bnnt'>ลูกค้าทั้งหมด</button></a> -->
                <form method="post">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                while ($trow = mysqli_fetch_array($user_all)) {
                                                    ...
                                                    // $chk = mysqli_query($con,"SELECT (COUNT(room) > 1) FROM `user` WHERE room = $room");
                                                    // $repeat = mysqli_fetch_assoc($chk);
                                                    ...
                                                    if ($room != null) {
                                                        ...
                                                        echo "<center><lable>" . $trow['room'] . "</lable></center>";
                                                        ...
                                                        echo '
                                                            ...
                                                            <td><a href=lease.php?lease=' . $id . ' <button class="btn btn-edit" style="background-color:green;color:white"> <i class="fa fa-edit" ></i> พิมพ์สัญญา</button></a></td>
                                    ...
                                    <script>
                                        function calAge() {
                                            ...
                                            if (ageYear >= "0" && ageYear < "18") {
                                                ...
                                                document.getElementById("sum").innerHTML = ('<font color="red"><i class="fa fa-times-circle"></i> อายุของคุณมากเกินไป</font>');
                                                return {
                                                    ageYear
                                                };
                                            } else {
                                            ...
                                            $(document).ready(function() {
                                                $('#personal').on('keyup', function() {
                                                    if ($.trim($(this).val()) != '' && $(this).val().length == 13) {
                                                        ...
                                                        if (result === false) {
                                                            document.getElementById("error_personal").innerHTML = ('<font color="red"><i class="fa fa-times-circle"></i> เลขบัตรประชาชนผิด</font>');
                                                            return result;
                                                        }else if(result.length > 1 && result.length < 13){
                                                            document.getElementById("error_personal").innerHTML = ('<font color="green"><i class="fa fa-times-circle"></i> กรุณาระบุข้อมูลในช่องว่าง</font>');
                                                            return result;
                                                        }else {
                                                            document.getElementById("error_personal").innerHTML = ('<font color="green"><i class="fa fa-check-circle"></i> เลขบัตรประชาชนถูกต้อง</font>');
                                                            return result;
                                                        }
                                                    } else {
                                ...
                                <tr>
                                    ...
                                    <td class="tbs">
                                        ...
                                        <select name="district_id" id="district" class="form-control" style="width:100%">
                                            <option value="" class="fontcity">กรุณาเลือก แขวง/ตำบล</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
