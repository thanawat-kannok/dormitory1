            ...
            <div class="panel-footer">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="reservation_money" class="text"
                        value="<?php echo number_format($row['reservation_money']) ?>" disabled>
                    <br>
                    ...
                    <lable style='font-size:12px;color:red'>ค่าห้อง ห้องละ <?php  echo $row['minimum']?> จำนวน <?php  echo $row['room_count']?> ห้อง รวม <?php  echo number_format($sum)?></lable>
                    <br>
                    ...
                    <div>
                        ...
                        <input class="form-control" type="file" name="fileupload" accept="image/png, image/jpeg, image/jpg, image/AVIF" required>
                    </div>
                    ...
                    <div>
                        ...
                        required  onkeypress="return isNumberKey(this, event);">
                    </div>
                    <br>

                    <div>
                        <label>ชื่อบัญชี</label>
                        <input class="form-control" type="text" name="namebank" required>
                    </div>
                    <br>
...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_query($con, $rpsql)) {
        ...
        echo "<script type='text/javascript'> window.location ='print.php?rid=" . $payid . "'</script>";
    }
}
?><script>
