...
<body>
	...
	$sql ="SELECT reservation_id,prefix_name,fname,lname,phone,day_reserve,day_checkin,day_checkout,reservation_money,
    reserve_status,proof_of_transfer,room_category.name AS cname,room_type.name AS tname,bed_type.name AS bname,reserve.pay,
     reserve.nodays, room_details.price, room_details.other, reserve.refund, room_details.reservation, reserve.reason
      ...
      where reserve.reservation_id = $rid ";
    ...
    <header>
        <button style="margin:20px auto; background-color:green;" class="hideWhenPrint print"
        ...
        <address>
            ...
            <p><?php echo $rowp['address'] ?><br>
                ...
                สถานะการจอง : <?php if($status == "ชำระแล้ว"): ?><lable class="status"><?php echo $status;?></lable>
                <?php endif ?>
                <?php if($status == "การจองผิดพลาด"): ?>
                <lable class="statusred">
                    <?php echo $status;?>
                </lable>
                <br>
                <lable class="statusred">
                    เหตุผล : <?php echo $reason ?>
                </lable>
                <?php endif ?>
            </p>
            ...
            <tbody>
                ...
                <center>
                    ...
                    <tr>
                        ...
                        <td colspan="4"><span class="status">หลักฐานการโอนเงิน<br>
                                <center>
                                    <img id="myImg" src="../assets/img/reservation/<?php echo $proof_of_transfer?>"
                                        class="resize" width="300px" height="300px">
                                </center>
                    ...
                    <tr>
                        ...
                        <td colspan="2"><span class="status">หลักฐานการโอนเงิน<br>
                                <center>
                                    <img id="myImg" src="../assets/img/reservation/<?php echo $proof_of_transfer?>"
                                        class="resize" width="300px" height="300px">
                                </center>
                        ...
                        <td colspan="2">
                            <span class="statusred">หลักฐานการโอนเงินคืน<br>
                                <center>
