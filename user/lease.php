...
<body>
    <table border="0" cellpadding="" style="background-color:white">
        <tr>
            <td>
                <table style="border:0px solid black;background-color:white;padding: 3.81px;" width="100%">
                    ...
                    <tr>
                        <td colspan="3">ข้าพเจ้า <abbr
                                title="">&nbsp&nbsp&nbsp<?php echo $name[0] ?>&nbsp&nbsp&nbsp</abbr>
                    ...
                    <tr>
                        <td colspan="3">ที่อยู่ <abbr title="">&nbsp&nbsp&nbsp
                                ตำบล/แขวง.<?php echo $provin['nameD'] ?>&nbsp&nbsp&nbsp
                                <abbr title="">&nbsp อำเภอ/เขต. <?php echo $provin['nameA'] ?>&nbsp
                                    <abbr title="">&nbsp จังหวัด. <?php echo $provin['nameP'] ?>&nbsp
                                        <abbr title="">&nbsp รหัสไปรษณีย์.
                                            <?php echo $provin['zip'] ?>&nbsp&nbsp&nbsp&nbsp
                        </td>
                    </tr>
                    <tr>
                        <td colspan="3">เลขที่บัตรประชาชน <abbr
                                title="">&nbsp&nbsp&nbsp<?php echo base64_decode($id); ?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</abbr>
                            สถาที่(ทำงาน/เรียน)
                            .............................................................................................................
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="3">ตกลงทำสัญญาขอเช่าห้องพักหมายเลข <abbr
                                title="">&nbsp&nbsp&nbsp<?php echo $room ?>&nbsp&nbsp&nbsp</abbr>
                    ...
                    <tr>
                        <td colspan="3">เริ่มการเช่าตั้งแต่ วันที่<abbr title="">&nbsp&nbsp&nbsp
                            ...
                            โดยตกลงจ่ายค่าเช่าเป็นรายเดือนเดือนละ <abbr title="">
                                ...
                                ?></abbr> บาท
                            <abbr title="">(&nbsp&nbsp&nbsp&nbsp <?php echo $type['name_th_price']; ?>
                                &nbsp&nbsp&nbsp&nbsp)&nbsp </abbr>
                    </tr>
                    <tr>
                        <td colspan="3"> และค่าประกันจำนวนเงิน <abbr title="">
                                ...
                                ?></abbr> บาท
                            <abbr title="">(&nbsp&nbsp&nbsp&nbsp <?php echo $type['name_th_other']; ?>
                                &nbsp&nbsp&nbsp&nbsp)&nbsp </abbr>
                        </td>
            </td>
        </tr>
        ...
        <tr>
            <td colspan="3">ที่อยู่
                ที่อยู่ <abbr title="">&nbsp&nbsp&nbsp ตำบล/แขวง.<?php echo $provinces2 ?>&nbsp&nbsp&nbsp
                    <abbr title="">&nbsp อำเภอ/เขต. <?php echo $amphures2 ?>&nbsp
        ...
        <tr>
            <td colspan="3">เลขที่บัตรประชาชน <abbr
                    title="">&nbsp&nbsp&nbsp<?php echo base64_decode($id2); ?>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</abbr>
                สถาที่(ทำงาน/เรียน)
                .............................................................................................................
            </td>
        </tr>
        ...
        <tr>
            <td colspan="3">
                ...
                <lable class="backspace">หากข้าพเจ้าประพฤติผิดสัญญาอย่างใดอย่างหนึ่ง
                    ...
                    ข้าพเจ้ายินยอมให้ขนทรัพย์ออกจากห้องพักมาไว้บริเวณใต้ที่พัก
                    โดยผู้เช่าจะดูแลทรัพย์สินหลังจากขนย้ายออกจากห้องพักเอง
                    ซึ่งผู้ให้เช่าไม่ต้องรับผิดชอบความเสียหายของทรัพย์สินภายในห้องและที่ขนออกจากห้อง
                </lable>
                </div>
                <br>
                <blockquote cite="ChillChillJapan : https://chillchilljapan.com/">
                    <div align="justify">
                        <lable class="backspace">สัญญานี้ได้ทำเอาไว้เป็นหลักฐาน 2 ฉบับ
                            โดยให้ผู้เช่าและผู้ให้เช่าเก็บไว้ฝ่ายละ 1 ฉบับ
    ...
    <a href="profile1.php"><button class="hideWhenPrint button">กลับหน้าหลัก</button></a>
