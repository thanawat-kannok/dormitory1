      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>จองห้องพัก</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="user/roomDay_log.php">รายวัน</a></li>
              <li><a href="user/roomMonth_log.php">รายเดือน</a></li>
            </ul>
          </li>
          ...
          <?php if (isset($_SESSION['personal'])) : ?>
            ...
            <li class="dropdown"><a href="#" class="dropdown"><i class="bi bi-person"></i><?php echo $_SESSION['fname']; ?>( ผู้ใช้ )<i class="bi bi-chevron-down"></i></a></a>
              <ul>
                <li><a href="user/profile1.php">ข้อมูลส่วนตัว</a></li>
                <li><a href="user/myreservation.php">การจองของฉัน</a></li>
                <li>
            ...
            <div class="item">
              <div class="pad15">
                <img src="imge\show_room\<?php echo $row['room_picture'];
                                          ?>" style="width:100%;height:168px" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
              </div>
            </div>
          <?php endwhile ?>
        </div>
